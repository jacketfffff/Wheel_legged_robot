...
private:
    ...
    unsigned char left_ankle_lock[COMMAND_SIZE] = {0x53,0x10,0x05,0x07,0xAA,0x00,0x00,0x00};
    unsigned char right_ankle_cut[COMMAND_SIZE] = {0x53,0x10,0x10,0x17,0x00,0x00,0x00,0x00};
    unsigned char right_ankle_lock[COMMAND_SIZE] = {0x53,0x10,0x05,0x17,0xAA,0x00,0x00,0x00};
    ...
    unsigned char get_encoder[COMMAND_SIZE] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
